...
public class ObjectNameView : MonoBehaviour {
	...
	public Color textColor = new Color(211, 15, 255, 0f);
	...
	void Awake() {
		...
		if (gameObject.name == "BonusHealth(Clone)") {
			text = "Health 5";
		}
		if (gameObject.name == "BonusGun5(Clone)") {
			text = "Gun 4";
		}
		if (gameObject.name == "BonusGun4(Clone)") {
			text = "Gun 3";
		}
		if (gameObject.name == "BonusGun3(Clone)") {
			text = "Gun 2";
		}
		if (gameObject.name == "BonusGun2(Clone)") {
			text = "Gun 1";
		}
		TextShadowReady();
	}
